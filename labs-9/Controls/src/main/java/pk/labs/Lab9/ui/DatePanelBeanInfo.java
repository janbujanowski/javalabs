 ...
 * @author mikus
 */
public class DatePanelBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( pk.labs.Lab9.ui.DatePanel.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_date] = new PropertyDescriptor ( "date", pk.labs.Lab9.ui.DatePanel.class, "getDate", "setDate" ); // NOI18N
            properties[PROPERTY_date].setPreferred ( true );
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", pk.labs.Lab9.ui.DatePanel.class, "getName", "setName" ); // NOI18N
        }
